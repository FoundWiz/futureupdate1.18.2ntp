...
public class ModBlocks {
    ...
    //Sweets
    public static final RegistryObject<Block> MUSHROOM_POT_PIE = BLOCKS.register("mushroom_pot_pie",
            () -> new PieBlock(BlockBehaviour.Properties.copy(Blocks.CAKE), ModItems.MUSHROOM_POT_PIE_SLICE));
